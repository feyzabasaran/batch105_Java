...
public class C03_compute {
    public static void main(String[] args) {
        ...
        mp1.computeIfPresent("B",(k,v) -> 2*v); // compute=hesaplamak computeIfPresent, key varsa hesapla
        // if kullanmadan tek satirda yapılabilir
        ...
        // E'nin degerini 4 artir (varsa ya da yoksa gibi bir sart yok yani)
