...
public class C01_putIfAbsent {
    public static void main(String[] args) {
        ...
        mp1.put("A",5); // map'e eleman ekleme
        mp1.put("B",3);
        mp1.put("C",7);
        System.out.println(mp1); // {A=5, B=3, C=7}

        // putIfAbsent element mevcut degilse ekle anlamina geliyor
        System.out.println(mp1.putIfAbsent("D", 9)); // null -burda ekleme yapti
        System.out.println(mp1); // {A=5, B=3, C=7, D=9}

        System.out.println(mp1.putIfAbsent("D", 15)); // 9 -zaten var bunun degeri diye olan degeri donduruyor
        System.out.println(mp1); // {A=5, B=3, C=7, D=9}
