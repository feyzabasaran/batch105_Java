...
public class C05_replace {
    public static void main(String[] args) {
        ...
        System.out.println(mp1.replace("C", 10)); // direk boyle yazdirirsak eski degerini donduruyor // 7
        ...
        // map'de D olmadigi icin default olarak benim girdigim degeri getiriyor
