...
public class C06_TreeMap {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(mp1.higherKey("D")); // F   girilen degerden buyuk olan
        System.out.println(mp1.higherKey("H")); // T
        System.out.println(mp1.higherKey("U")); // null
        System.out.println(mp1.higherEntry("M")); // T=3
        // M'den buyuk olan ne olur diye bakiyor T'yi verir ama entry olarak
        ...
        System.out.println(mp1.floorKey("H")); // H dahil bakıyor ve asagi yuvarliyor
        ...
        // F dahil olmadan F'ye kadar olan map'i dondurur
        System.out.println(mp1.headMap("K")); // {A=5, C=7, F=8, H=3}
        // olsaydı H'den sonra olurdu diyerek H'ye kadar olan map'i dondurur
        ...
        System.out.println(mp1.pollFirstEntry()); // A=5 'i map'ten silip bize getiriyor
        System.out.println(mp1); // {C=7, F=8, H=3, T=3}

        System.out.println(mp1.pollLastEntry()); // T=3 'u map'ten silip bize getiriyor
        System.out.println(mp1); // {C=7, F=8, H=3}

        System.out.println(mp1.subMap("B", "G")); // {C=7, F=8}
        System.out.println(mp1.subMap("C","H"));  // {C=7, F=8}  Baslangic inclusive (dahil),bitis exclusive (dahil degil)
