...
public class C02_OverLoading {
    ...
    //Bir Class'da ayni isim ve ayni signature'a (method adı ve icindeki variable sayisi)
    // sahip iki method olmaz.
    /*
    ...
    */
    ...
    public static void carpim(int sayi3,int sayi4,int sayi5){ // carpim int int int
        System.out.println("Iki integer sayinin carpimi: "+sayi3*sayi4*sayi5);
    }
