...
public class C02_Maps {
    ...
    public static void main(String[] args) {
        ...
        // 104 no'lu ogrencinin subesini K yapin
        // meethod'da istenen key map'de varsa degistirip map'i geri dondurelim
        // yoksa hic bi islem yapmadan map'i geri dondurelim
        int ogrenciKey = 104;
        String yeniSube= "K";
        ...
        102=Veli-Cem-11-M-Soz,
        103=Ali-Cem-11-H-TM,
        104=Ayse-Can-10-K-MF, bunun subesini degistirdi.
        105=Hasan-Can-11-K-MF,
        106=Fatma-Han-10-K-Soz,
        108=Hikmet-Han-10-M-TM
        }
